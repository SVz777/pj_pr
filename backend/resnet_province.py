...
train_dir = './train_images/training-set/chinese-characters'
validation_dir = './train_images/validation-set/chinese-characters'
...
checkpoint = ModelCheckpoint(
    filepath='./province_resnet_model.hdf5', monitor='val_acc',
